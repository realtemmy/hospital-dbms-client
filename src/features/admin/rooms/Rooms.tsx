...
const Rooms = () => {
  ...
  const handleAssignRoom = (values: AssignRoomFormValues) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-6 rounded-xl shadow-sm">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Manage and monitor hospital rooms efficiently
          </p>
        </div>
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              <DialogTitle>Add Patient to room</DialogTitle>
              <AssignRoom onSubmit={handleAssignRoom} />
            </DialogHeader>
          </DialogContent>
        </Dialog>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <KPICards
          kpis={{ color: "blue", icon: Home, count: 24, title: "Total rooms" }}
        />
        <KPICards
          kpis={{
            color: "green",
